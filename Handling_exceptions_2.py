# Example 11
# The program in example 11 below handles exceptions that might occur when the
# program opens and reads from a file. This program contains only one try block,
# which begins at line 12 and includes all the regular code in the main function. This one
# try block has three except blocks at lines 48, 52, and 56 that handle
# FileNotFoundError, PermissionError, and ZeroDivisionError.
