...
# Notice in the get_float function at line 28 there is a try block. The try
# block is part of a loop that validates user input in the get_float function. Notice at
# line 43 that the except block handles ValueError which is the type of exception that
# the float function raises when it tries to convert text to a number but the text
